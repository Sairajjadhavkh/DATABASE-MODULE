...
(148,'Eric','Jecob','+65 7555','103800.00'),(151,'Young','Jeff','2125557413','138500.00');
...
ALTER TABLE ORDERS ADD package_stat VARCHAR(50);
...
select First_Name,Last_Name,customers.customer_id,order_id,Deliver from customers left outer join orders
